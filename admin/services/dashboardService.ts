...
class DashboardService {
  ...
  private getDefaultDashboards(): Dashboard[] {
    return [
      {
        id: 'default_family_overview',
        name: 'Family Overview',
        description: 'Main dashboard showing family statistics and recent activity',
        isDefault: true,
        createdAt: '2024-01-15T00:00:00.000Z',
        updatedAt: '2024-01-20T00:00:00.000Z',
        components: [
          {
            id: 'comp_family_stats',
            type: 'stats',
            title: 'Family Statistics',
            dataSource: 'family_stats',
      ...
      },
      {
        ...
        description: 'Dashboard for managing family content and media',
        isDefault: false,
